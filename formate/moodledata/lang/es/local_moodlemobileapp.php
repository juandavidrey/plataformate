...
$string['addon.calendar.defaultnotificationtime'] = 'Tiempo de notificación por defecto';
...
$string['addon.coursecompletion.completed'] = 'Finalizado';
$string['addon.coursecompletion.completiondate'] = 'Fecha de finalización';
...
$string['addon.coursecompletion.coursecompletion'] = 'Finalización del curso';
$string['addon.coursecompletion.criteria'] = 'Criterios';
$string['addon.coursecompletion.criteriagroup'] = 'Grupo de criterios';
$string['addon.coursecompletion.criteriarequiredall'] = 'Son necesarios todos los criterios que aparecen más abajo';
$string['addon.coursecompletion.criteriarequiredany'] = 'Es necesario cualquiera de los criterios que aparecen más abajo';
$string['addon.coursecompletion.inprogress'] = 'En curso';
$string['addon.coursecompletion.manualselfcompletion'] = 'Autocompletar manualmente';
$string['addon.coursecompletion.notyetstarted'] = 'Aún no comenzado';
$string['addon.coursecompletion.pending'] = 'Pendiente';
$string['addon.coursecompletion.required'] = 'Obligatorio';
$string['addon.coursecompletion.requiredcriteria'] = 'Criterios necesarios';
$string['addon.coursecompletion.requirement'] = 'Requisito';
$string['addon.coursecompletion.status'] = 'Estado';
$string['addon.coursecompletion.viewcoursereport'] = 'Ver informe del curso';
...
$string['addon.messages.blockcontactconfirm'] = 'Usted dejará de recibir mensajes de este contacto.';
...
$string['addon.messages.removecontactconfirm'] = 'El contacto se eliminará de su lista de contactos.';
...
$string['addon.mod_glossary.bysearch'] = 'Busca';
...
$string['core.login.invaliddate'] = 'Fecha incorrecta';
$string['core.login.invalidmoodleversion'] = 'Versión de Moodle inválida. La versión mínima requerida es:';
...
$string['core.mainmenu.togglemenu'] = 'Cambiar menú';
...
$string['core.user.editingteacher'] = 'Profesor';
$string['core.user.manager'] = 'Gestor';
$string['core.user.sendemail'] = 'Correo electrónico';
$string['core.user.student'] = 'Estudiante';
$string['core.user.teacher'] = 'Profesor sin permiso de edición';
