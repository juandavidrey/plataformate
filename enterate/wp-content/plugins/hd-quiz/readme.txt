...
= NOTICE ⚠️ =
This version, 1.5.0 (released October 21st) is the first major code change in years. I have completely rewritten HD Quiz from the ground up. Upgrading to this version should not cause any issues, but if you do experience a problem, please do not hesitate to ask for support.
