...
//$hd_questionName = sanitize_text_field(get_option( 'hd_questionName' ));
			...
			<div id="hdq_form_wrapper">
				<div class = "hdq_tab">
					...
					<div class = "hdq_accordion">
						...
						<div>
							<ul class = "hdq_list">
								<li>Select HD Quiz from the left sidebar, then Add New Question.</li>
								...
								<li>In the right sidebar, you will see a metabox called Quizzes with a list of all quizzes you have created. Select the quiz that this question belongs to.</li>
					...
					<div class = "hdq_accordion">
						...
						<div>
							<p>
								By default, questions are ordered by creation date - most recent first, because this is the default order that WordPress uses for post queries. However, I strongly recommend installing and using the <a href="plugin-install.php?tab=plugin-information&amp;plugin=intuitive-custom-post-order&amp;TB_iframe=true&amp;width=772&amp;height=905" class="thickbox">Intuitive Custom Post Order</a> plugin. I have ZERO affiliation with this plugin, but it works great!								</p>
							<p>
								Once installed:
							</p>
							<ul class = "hdq_list">
								<li>Find the Intuitive CPO settings under <strong>Settings</strong> from the left sidebar</li>
								<li>Make sure <strong>Questions</strong> is checked</li>
								<li>You can now re-order questions with a simple drag-and-drop from the <strong>HD Quiz -> All Questions</strong> page.</li>
							</ul>
						</div>
					</div>
					<div class = "hdq_accordion">
