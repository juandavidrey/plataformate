...
require_once dirname(__FILE__) . '/views/wplp-block-settings.php'; //view wplp block settings
require_once dirname(__FILE__) . '/views/wplp-configuration.php'; //view config page
