...
<html lang="es">
  <head>
    ...
    <meta name="keywords" content="plataformate, platafórmate, gobernación del Meta, juventud, juventudes, secretaría social, gerencia para las juventudes" />
		<meta name="author" content="Gerencia para las juventudes" />
    <meta name="google-site-verification" content="tbohsL-3JfoSydOefBDvZ8W6dezBc8Rxbg_DvCRbh3Y" />
    <title>@yield('meta-title', config('app.name')) </title>
    <meta name="description" content="@yield('meta-description', 'Unidos por los jóvenes')">
    <!-- Bootstrap CSS -->
