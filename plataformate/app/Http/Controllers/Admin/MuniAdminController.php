...
class MuniAdminController extends Controller
{
	...
	if (!empty($request->file('fotorep1')) && $request->hasFile('fotorep1')) {
          $municipio->fotorep1= $request->file('fotorep1')->store('/public/fotosrep');
	}
	if (!empty($request->file('fotorep2')) && $request->hasFile('fotorep2')) {
          $municipio->fotorep2= $request->file('fotorep2')->store('/public/fotosrep');
	}
